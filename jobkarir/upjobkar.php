        ...
        <tr class="text-center">
          ...
          <td><?php echo $data['Id'] ?></td>           
           <td class="text-center"> 
            <button id=" <?php echo $data['Id'] ?> - <?php echo $data['nmgambar'] ?> - <?php echo $data['keterangan'] ?> - <?php echo $data['nmkarir'] ?> - <?php echo $data['info'] ?> - <?php echo $data['status'] ?>" class="btn btn-icon btn-sm text-success btnEDIT" title="Edit"> 
             <i class="fas fa-edit"></i> 
            </button> 
           </td>
          <td><?php echo $data['nmgambar'] ?></td>
          <td><?php echo $data['keterangan'] ?></td>
          <td><?php echo $data['nmkarir'] ?></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-white bg-dark ">
        <h4 class="modal-title" id="exampleModalLabel">Edit Data Job(Karir)</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <form action="<?php echo htmlspecialchars('../../CRUD/guestbook/edit.php')?>" method="POST" >
                ...
                <label for="nohp" class="col-sm-3 ">Keterangan</label>
                 <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                  <label for="alm" class="col-sm-3 ">Nama Karir</label>
                  <div class="col-sm-9">
